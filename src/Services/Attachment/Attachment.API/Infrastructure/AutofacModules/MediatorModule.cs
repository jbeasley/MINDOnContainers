...
using MINDOnContainers.Services.Attachment.API.Application.DomainEventHandlers;
using MINDOnContainers.Services.Attachment.API.Application.Validations;
using MINDOnContainers.Services.Attachment.API.Infrastructure.Behaviors;
...
namespace MINDOnContainers.Services.Attachment.API.Infrastructure.AutofacModules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(typeof(CreateAttachmentCommand).GetTypeInfo().Assembly)
