...
{
    public class AttachmentAwaitingDeviceAndPortAssignmentsIntegrationEvent : IntegrationEvent
    {
        ...
        public AttachmentAwaitingDeviceAndPortAssignmentsIntegrationEvent(int attachmentId, string locationName,
