...
{
    public class AssignDeviceAndAttachmentPortsCommand : IRequest<bool>
    {
        [DataMember]
        ...
        public AssignDeviceAndAttachmentPortsCommand(int attachmentId, string locationName, int portPoolId, int numPortsRequired,
